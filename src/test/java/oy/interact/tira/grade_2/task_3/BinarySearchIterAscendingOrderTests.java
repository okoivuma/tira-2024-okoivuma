...
@DisplayName("Tests for iterative binary search")
class BinarySearchIterAscendingOrderTests {
	...
	void testTimePerformanceOfBinarySearch() {
		System.out.println("Time performance tests of filling, sorting (asc) and binary searching (iterative)");
