...
public interface StackInterface<E> {
    ...
    * 
    * Time complexity is O(1), or if reallocation is needed, O(n).
    * 
    * If the internal array does not have enough room for the element, the
    * implementation MUST first create a larger array, copy the elements
    * from the old array to the new array, and then replace the old array
    * with the new array. Then place the element in the array.
    *
    ...
    * Makes sure that the internal array is of default size.
    * Time complexity is O(1).
    *
    */
   public void clear();
